...
{{< image width=2 height=2 src="http://image.p1nant0m.com/202307161729019.png" caption="WebTech Information" src_s="http://image.p1nant0m.com/202307161729019.png" src_l="http://image.p1nant0m.com/202307161729019.png" >}}
...
{{< image src="http://image.p1nant0m.com/202307161729597.png" caption="Searchor Exploit PoC" src_s="http://image.p1nant0m.com/202307161729597.png" src_l="http://image.p1nant0m.com/202307161729597.png" >}}
...
{{< image src="http://image.p1nant0m.com/202307161729220.png" caption=".git directory" src_s="http://image.p1nant0m.com/202307161729220.png" src_l="http://image.p1nant0m.com/202307161729220.png" >}}

其中存在config文件，内容如下，

{{< image src="http://image.p1nant0m.com/202307161729821.png" caption="git config" src_s="http://image.p1nant0m.com/202307161729821.png" src_l="http://image.p1nant0m.com/202307161729821.png" >}}
...
{{< image src="http://image.p1nant0m.com/202307161729777.png" caption="Commands that can be executed by sudo" src_s="http://image.p1nant0m.com/202307161729777.png" src_l="http://image.p1nant0m.com/202307161729777.png" >}}
...
{{< image src="http://image.p1nant0m.com/202307161728483.png" caption="execute the provided scripts" src_s="http://image.p1nant0m.com/202307161728483.png" src_l="http://image.p1nant0m.com/202307161728483.png" >}}
...
{{< image src="http://image.p1nant0m.com/202307161728969.png" caption="Inspect docker container started variables" src_s="http://image.p1nant0m.com/202307161728969.png" src_l="http://image.p1nant0m.com/202307161728969.png" >}}
...
{{< image src="http://image.p1nant0m.com/202307161728051.png" caption="Administrator is in the org with cody user" src_s="http://image.p1nant0m.com/202307161728051.png" src_l="http://image.p1nant0m.com/202307161728051.png" >}}

Boom！我们可以使用上面获得到的密码(**yuiu1hoiu4i5ho1uh**)登入administrator的账户，在管理员账户下我们发现了在 `/opt/scripts` 的文件，在gitea上我们便可以查看代码的主要逻辑。


{{< image src="http://image.p1nant0m.com/202307161728008.png" caption="scripts that owned by Administrator" src_s="http://image.p1nant0m.com/202307161728008.png" src_l="http://image.p1nant0m.com/202307161728008.png" >}}

在对代码进行审计后，我们发现full-chekcup Action中没有对传入的脚本文件路径进行限制，进而可以进行任意代码执行，


{{< image src="http://image.p1nant0m.com/202307161728704.png" caption="fragile point of the script execute logic" src_s="http://image.p1nant0m.com/202307161728704.png" src_l="http://image.p1nant0m.com/202307161728704.png" >}}
...
{{< image src="http://image.p1nant0m.com/202307161730297.png" caption="Get shell under the root user" src_s="http://image.p1nant0m.com/202307161730297.png" src_l="http://image.p1nant0m.com/202307161730297.png" >}}

最终也是读取了root.txt中存储的FLAG！

{{< image src="http://image.p1nant0m.com/202307161732018.gif" caption="Target Website" src_s="http://image.p1nant0m.com/202307161732018.gif" src_l="http://image.p1nant0m.com/202307161732018.gif" >}} 
