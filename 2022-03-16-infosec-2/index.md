...
{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/%E6%9C%AA%E5%91%BD%E5%90%8D%E7%BB%98%E5%9B%BE.jpg" caption="项目数据流图" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/%E6%9C%AA%E5%91%BD%E5%90%8D%E7%BB%98%E5%9B%BE.jpg" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/%E6%9C%AA%E5%91%BD%E5%90%8D%E7%BB%98%E5%9B%BE.jpg" >}}
...
{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20220315221341126.png" caption="启动 KDC 服务" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20220315221341126.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20220315221341126.png">}}
...
{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_1_1.png" caption="向KDC发起注册请求" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_1_1.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_1_1.png" >}}
...
{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_22.png" caption="在KDC输出的日志中查看相关的注册信息" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_22.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_22.png" >}}
...
{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_33.png" caption="ServerA向KDC获取ServerB的网络地址信息以及公钥" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_33.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_33.png" >}}

利用上述过程获取到的信息，ServerA与ServerB已经能够进行通信了，首先我们创建一个文件`helloB` 并在其中写入如下内容，

{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_44.png" caption="向待发送文件写入内容" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_44.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_44.png" >}}

使用命令：`./apollo setupreceiver --privk-file=privateK_B.key --listen-port=7071` 开启ServerB Receiver服务，如下所示，

{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_55.png" caption="开启ServerB Receiver服务" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_55.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_55.png" >}}

使用命令：`./apollo send --remote-info=./remote_B --sending-file=./helloB` 向ServerB Receiver发送加密数据，如下所示，


{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_66.png" caption="向ServerB Receiver发送加密数据" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_66.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_66.png" >}}

在 ServerB Receiver 端我们可以看见解密后的内容如下所示，

{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_77.png" caption="在 ServerB Receiver 端 查看解密后的内容" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_77.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image_77.png" >}}
