...
{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927142057006.png" caption="题目页面展示" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927142057006.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927142057006.png" >}}

​	我们随便的在编辑框中输入一点内容看看效果，

{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927142309716.png" caption="尝试输入特殊字符" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927142309716.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927142309716.png" >}}

​	可以看到我们输入的内容被进行了过滤编码，`<`标签开闭合符号显然就在其中，我们考虑是否有某种方式绕过过滤实现`XSS`,单击保存后我们可以看到下列提示，

{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927142537265.png" caption="保存后提示" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927142537265.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927142537265.png" >}}
...
{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927160743166.png" caption="后端返回的 Data" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927160743166.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927160743166.png" >}}
...
{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927190809809.png" caption="访问恶意页面触发脚本执行" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927190809809.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927190809809.png" >}}

​	我们注入的恶意脚本就从数据库中导出并且构成HTML文档的一部分，被浏览器解释执行，

{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927191107611.png" caption="恶意代码拼接进入 HTML 文档" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927191107611.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927191107611.png" >}}

​	最终我们可以在受我们控制的服务器中获得我们的FLAG，

{{< image src="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927191308837.png" caption="flag 获取" src_s="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927191308837.png" src_l="https://cdn.jsdelivr.net/gh/wgblikeW/blog-imgs/image-20210927191308837.png" >}}
