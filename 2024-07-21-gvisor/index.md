...
{{< image src="https://image.p1nant0m.com/202407292316118.png" caption="Virtual hardware Sandboxing" src_s="https://image.p1nant0m.com/202407292316118.png" src_l="https://image.p1nant0m.com/202407292316118.png" height=100px width=100px >}}
...
{{< image src="https://image.p1nant0m.com/202407292324150.png" caption="Rule Based Sandboxing" src_s="https://image.p1nant0m.com/202407292324150.png" src_l="https://image.p1nant0m.com/202407292324150.png" >}}
...
{{< image src="https://image.p1nant0m.com/202407292333690.png" caption="gVisor Sandboxing" src_s="https://image.p1nant0m.com/202407292333690.png" src_l="https://image.p1nant0m.com/202407292333690.png" >}}

### gVisor 基础架构

{{< image src="https://image.p1nant0m.com/202407292335721.png" caption="gVisor Architecture" src_s="https://image.p1nant0m.com/202407292335721.png" src_l="https://image.p1nant0m.com/202407292335721.png" >}}
...
{{< image src="https://image.p1nant0m.com/202407302218817.png" caption="Different Platform In gVisor" src_s="https://image.p1nant0m.com/202407302218817.png" src_l="https://image.p1nant0m.com/202407302218817.png" >}}
...
{{< image src="https://image.p1nant0m.com/202407302228208.png" caption="The Swiss Cheese Cyber Security Defense-in-Depth Model" src_s="https://image.p1nant0m.com/202407302228208.png" src_l="https://image.p1nant0m.com/202407302228208.png" >}}
...
{{< image src="https://image.p1nant0m.com/202407302253582.png" caption="Memory Access Benchmark" src_s="https://image.p1nant0m.com/202407302253582.png" src_l="https://image.p1nant0m.com/202407302253582.png" >}}
...
{{< image src="https://image.p1nant0m.com/202407302256324.png" caption="Memory Usage Benchmark" src_s="https://image.p1nant0m.com/202407302256324.png" src_l="https://image.p1nant0m.com/202407302256324.png" >}}

**CPU performance**

该图表展示了 `sysbench` 对每秒 CPU 事件的测量。每秒事件数是基于一个 CPU 密集型的任务场景：计算指定范围内的所有质数。我们注意到 `runsc` 没有造成性能损失，因为在两种情况下代码都是以原生方式执行的。

{{< image src="https://image.p1nant0m.com/202407302303128.png" caption="CPU Events" src_s="https://image.p1nant0m.com/202407302303128.png" src_l="https://image.p1nant0m.com/202407302303128.png" >}}

该图表显示了一个 TensorFlow 工作负载，其中进行的任务为卷积神经网络（CNN）训练。所指示的时间包括工作负载的完整启动和运行时间。

{{< image src="https://image.p1nant0m.com/202407302306498.png" caption="CNN Training Time" src_s="https://image.p1nant0m.com/202407302306498.png" src_l="https://image.p1nant0m.com/202407302306498.png" >}}
...
{{< image src="https://image.p1nant0m.com/202407302309820.png" caption="Start-Up Time" src_s="https://image.p1nant0m.com/202407302309820.png" src_l="https://image.p1nant0m.com/202407302309820.png" >}}

**System calls**

该图表展示了在不同平台上进行原始系统调用所需的时间。测试是通过一个自定义的二进制文件实现的，该文件执行大量的系统调用并计算所需的平均时间。

{{< image src="https://image.p1nant0m.com/202407302315199.png" caption="不同容器运行时实现在进行系统调用所需要的平均时间" src_s="https://image.p1nant0m.com/202407302315199.png" src_l="https://image.p1nant0m.com/202407302315199.png" >}}
...
{{< image src="https://image.p1nant0m.com/202407312103643.png" caption="在 gVisor 沙盒中运行 Redis 并执行一系列 Redis 操作的 RPS" src_s="https://image.p1nant0m.com/202407312103643.png" src_l="https://image.p1nant0m.com/202407312103643.png" >}}
...
{{< image src="https://image.p1nant0m.com/202407312108229.png" caption="不同运行时下的上传/下载带宽" src_s="https://image.p1nant0m.com/202407312108229.png" src_l="https://image.p1nant0m.com/202407312108229.png" >}}

该图表显示了简单的 node 和 ruby Web 服务在接收到请求时渲染模板的结果。因为这些合成基准测试每个请求做的工作很少，就跟 Redis 的情况一样，存在较高的性能开销。在实践中，应用程序做的工作越多，结构性成本的影响就越小。

{{< image src="https://image.p1nant0m.com/202407312254369.png" caption="不同运行时下的简单 Web 服务 RPS" src_s="https://image.p1nant0m.com/202407312254369.png" src_l="https://image.p1nant0m.com/202407312254369.png" >}}

**File System**

下图展示了 `fio` 对磁盘进行读写操作的结果。在这种情况下，磁盘很快就成为了性能瓶颈。

{{< image src="https://image.p1nant0m.com/202407312258895.png" caption="不同运行时下各种 I/O 操作的带宽" src_s="https://image.p1nant0m.com/202407312258895.png" src_l="https://image.p1nant0m.com/202407312258895.png" >}}

该图表展示了使用 `tmpfs` 挂载时的原始I/O性能，这在 `runsc` 的情况下时沙箱内部的行为。通常，这些操作与在内存中复制数据的开销相似，我们并没有看到 VFS（虚拟文件系统）操作相关的带来的性能影响。

{{< image src="https://image.p1nant0m.com/202407312300889.png" caption="不同运行时下在 tmpfs 挂载时的原始 I/O 性能表现" src_s="https://image.p1nant0m.com/202407312300889.png" src_l="https://image.p1nant0m.com/202407312300889.png" >}}
...
{{< image src="https://image.p1nant0m.com/202407312309703.png" caption="不同运行时下在不同并发级别对同一静态文件进行访问时的传输速率" src_s="https://image.p1nant0m.com/202407312309703.png" src_l="https://image.p1nant0m.com/202407312309703.png" >}}

对于那些受限于原始磁盘I/O以及计算和文件系统混合操作的基准测试来说，文件系统操作开销不那么成问题。该图表显示了一个 `ffmpeg` 容器启动、加载并转码一个 27MB 输入视频所需的总时间。

{{< image src="https://image.p1nant0m.com/202407312322221.png" caption="不同运行时启动、加载并转码一个 27MB 输入视频所需的总时间" src_s="https://image.p1nant0m.com/202407312322221.png" src_l="https://image.p1nant0m.com/202407312322221.png" >}}

下图展示了gVisor不同的沙箱化架构方案，以及性能与安全性之间的Trade-off（牺牲一定的安全性保证以获取性能的提高）。

{{< image src="https://image.p1nant0m.com/202407312323708.png" caption="Security & Performance Trade-off with different architecture" src_s="https://image.p1nant0m.com/202407312323708.png" src_l="https://image.p1nant0m.com/202407312323708.png" >}}
